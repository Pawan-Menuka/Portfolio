...
export default function Layout() {
  ...
  return <>
    ...
    {hasPageChrome && <header className="site-header">
      <Link className="wordmark" to="/" aria-label={`${name} — Home`}><span className="wordmark-logo-frame" aria-hidden="true"><img className="wordmark-logo" src="/pawan-menuka-logo.png" alt="" width="56" height="56" /></span></Link>
    ...
    {location.pathname === '/' ? <footer className="site-footer ocean-footer">
      <div className="ocean-footer-bottom">
        <Link className="ocean-footer-brand" to="/" aria-label="Pawan Menuka — Home"><img src="/pawan-menuka-logo.png" alt="" width="56" height="56" loading="lazy" decoding="async" /><span>Pawan Menuka<small>Portfolio</small></span></Link>
      ...
      <Link className="ocean-footer-brand" to="/" aria-label="Pawan Menuka — Home"><img src="/pawan-menuka-logo.png" alt="" width="56" height="56" loading="lazy" decoding="async" /><span>Pawan Menuka<small>{titles[location.pathname] || (location.pathname.startsWith('/projects/') ? 'Project' : 'Portfolio')}</small></span></Link>
